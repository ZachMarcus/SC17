...
//    const int N_ELEMENTS=1024*1024;
    const int N_ELEMENTS=128*128;
    unsigned int platform_id=0, device_id=1;
    ...
    try{
        ...
        std::cout << "Ran getPlatform" << std::endl;
...
//            std::cout << device << std::endl;
 ...
 //       return 0;
        ...
        std::cout << "Devices size on platform 0: " << devices.size() << std::endl;
